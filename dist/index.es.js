...
import { merge, map, find, matchesProperty } from 'lodash';
...
var Plyr = !main_29 ? require('plyr') : require('plyr/dist/plyr.polyfilled.min.js');
...
var SlickText = function SlickText(_ref) {
  ...
  return React.createElement("div", {
    ...
    className: "title"
  }, item.title, " ", item.type === 'video' ? React.createElement("span", {
    className: "play-text"
  }, " (Click to play)") : ''), React.createElement("span", {
    className: "counter"
  }, ' ', index + 1, "/", totalCount));
};
...
var GallerySlider = function GallerySlider(_ref) {
  ...
  var combinedSettings = merge({}, settings, SLICK_DEFAULT_SETTINGS, methodDefaults);
  return React.createElement("div", {
    className: "media-slider"
  }, React.createElement(Slider, _extends_1({
    ref: sliderRef
  }, combinedSettings), sliderData && sliderData.length && map(sliderData, function (item, index) {
    return item.type === 'image' ? React.createElement(React.Fragment, {
      key: index
      ...
      key: index
    }, React.createElement(VideoWrapper, {
      item: item,
      index: index,
      onClickHandler: onClickHandle,
      count: sliderData.length
  ...
  createClass(GallerySlider$1, [{
    ...
    value: function filterSliderData() {
      ...
      var filterPropertyWithCode = function filterPropertyWithCode(sliderData) {
        var _find = find(sliderData, matchesProperty('propertyId', property)),
            galleryData = _find.galleryData;

        var galleryFiltered = find(galleryData, matchesProperty('galleryCode', code)); //     if(item.propertyId === property && item.galleryData) {
    ...
    value: function render() {
      ...
      return React.createElement(GallerySlider, {
...
export default GallerySlider$1;
